...
import { 
  ...
  PermissionType as PrismaPermissionType, // Importa o enum do Prisma
  Prisma, // Importa o Prisma para acessar tipos como Decimal
} from '@prisma/client';
...
// Re-exporta o PermissionType do Prisma
...
export interface FiscalNote extends Omit<PrismaFiscalNote, 'status' | 'amount'> {
  status: InvoiceStatus; // Usa o nosso enum customizado
  amount: Prisma.Decimal | null; // CORREÇÃO: Usa o tipo Decimal do Prisma
  history?: NoteHistoryEvent[];
  attestedBy?: string | null;
  attestedAt?: Date | null;
  observation?: string | null;
  user?: Partial<PrismaUser>; // Include user for accessing email
  creator?: Partial<PrismaUser>; // Adicionado para refletir o schema
